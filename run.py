...
parser.add_argument(
    ...
    type=float,
    metavar="Alpha",
    help="The weight of the parameter loss function",
)
...
args.info = f"alpha{args.alpha}_depth{args.depth}_" + args.info
print("==> model info '{}'".format(args.info))
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, c_loss, pm_loss, train_acc = train(
        ...
        # append logger file
        logger.append(
            [state["lr"], train_loss, c_loss, pm_loss, test_loss, train_acc, test_acc]
        )
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    return (losses.avg, classification_loss / count, pm_loss / count, top1.avg)
